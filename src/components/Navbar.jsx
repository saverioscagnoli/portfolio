...
import { Flex, VStack, Box, IconButton, useColorMode, Image, Heading, List, ListItem, Link } from '@chakra-ui/react'
    ...
    <VStack>
        <Flex  width='100%' height={20} align='center' marginLeft={-60}>
            ...
            <List display='flex' fontWeight='semibold' textUnderlineOffset={2}>   
                 ...
                 <Link href='https://github.com/saverioscagnoli/portfolio' isExternal><ListItem padding={2}>Source</ListItem></Link> 
            </List>
